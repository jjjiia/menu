...
function dataDidLoad(error, data) {
	...
	displayResults()
	//draw(topLevelDictionary)
	frm1.searchTerm.value = ""
	topLevelDictionary = {}
}

function displayResults(){
	d3.select("#output").html("<span style=\"color:red\">Showing results for: "+global.searchTerm+"</span></br></br><pre>"+JSON.stringify(convertTree(topLevelDictionary)[0], null, 2)+"</pre>")
