...
function UpdateAll(enteredTerm){
	...
	drawChart(convertTree(rightDictionary)[0],convertTree(leftDictionary)[0])
	frm1.searchTerm.value = ""
	rightDictionary = {}
	leftDictionary = {}
}
...
function drawChart(treeData, treeDataLeft) {
	// Calculate total nodes, max label length
	    ...
	    root.y0 = 0;
		rootLeft = treeDataLeft;
	    rootLeft.x0 = viewerHeight / 2;
	    rootLeft.y0 = 0;
