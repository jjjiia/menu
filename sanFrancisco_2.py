...
basecity = "sanfrancisco"
baseURL1 = ".menupages.com/restaurants/"
baseURL2 = "/all-neighborhoods/all-cuisines/"
neighborhoods = ["downtown-waterfront", "soma-mission", "marina-heights", "richmond", "haight-castro-noe-valley", "sunset"]
...
if __name__ == "__main__":
    if len(sys.argv) >= 2 and sys.argv[1] == "crawl":
       ...
       for i in range(len(neighborhoods)):
		   ...
		   print city
		   outputfile = open(basecity+"_menus_address.csv","wb")
