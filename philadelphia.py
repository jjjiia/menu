...
neighborhoods = ["montgomery-county-w", "montgomery-county-e", "bucks-county", "ne-philly", "nw-philly-n-philly", "center-city", "delaware-county","university-city-w-philly", "south-philly"]
...
if __name__ == "__main__":
    if len(sys.argv) >= 2 and sys.argv[1] == "crawl":
       ...
       for i in range(len(neighborhoods)):
		   ...
		   print city
		   outputfile = open(basecity+"_"+city+"_menus_noRes.csv","wb")
